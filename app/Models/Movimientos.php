...
{
    use HasFactory;
    protected $fillable = ['id','Movimiento','Fecha', 'Total','FolioF','FechaF','Beneficiario','Concepto','fichaG_id','fichaD_id','comisionista_id','formap_id','empresa_id','banco_id','empleado_id'];
