...
class ClienteFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'Reg' => $this->faker->randomElement(['601','603','605','606','608']),
            'CFDI' => $this->faker->randomElement(['G03','G01','P01','D01','D02']),
            'TipoC' => $this->faker->randomElement(['Sin Tipo','Mostrador','Gobierno','Distribucion']),
            ...
            'Clasificacion' => $this->faker->randomElement(['Hospital','Medico General','Persona','Clinica','Laboratorio']),
