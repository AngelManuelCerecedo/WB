        ...
        <div class="border-b border-gray-900/10 pb-8">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2">
                    <label for="region" class="block text-sm font-medium leading-6 text-gray-900">Metodo de Pago</label>
                    <div class="mt-2">
                ...
                <div class="sm:col-span-1">
                    <label for="region" class="block text-sm font-medium leading-6 text-gray-900">Forma de Pago</label>
                    <div class="mt-2">
                ...
                <div class="sm:col-span-3">
                    <label for="last-name" class="block text-sm font-medium leading-6 text-gray-900">Razon Social</label>
                    <div class="mt-2" wire:ignore>
                ...
                <div class="sm:col-span-1">
                    <label for="city" class="block text-sm font-medium leading-6 text-gray-900">Total de la Factura</label>
                    <div class="mt-2">
                ...
                @if ($Metodo == 'PUE')                
                    <div class="sm:col-span-2 sm:col-start-1">
                        <label for="region" class="block text-sm font-medium leading-6 text-gray-900">Movimiento</label>
                        <div class="mt-1">
                                        ...
                                        @foreach ($Movimientos as $movimiento)
                                            @if ($movimiento->fichaI->Folio)
                                                <option value="{{ $movimiento->id }}">
                                                    {{ $movimiento->fichaI->Folio }} - $ {{ number_format($movimiento->Total, 2, '.', ',') }}
                                                </option>
                                            @endif
                                        @endforeach
                                    @endif
