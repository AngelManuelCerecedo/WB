        ...
        <div class="border-b border-gray-900/10 pb-8">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2 sm:col-start-1">
                    <label for="region" class="block text-sm font-medium leading-6 text-gray-900">Tipo de
                        Movimiento</label>
                    <div class="mt-2" wire:ignore>
                        <select id="select3" class="buscador" wire:model="movimientoSeleccionadaId">
                ...
                @if ($movimientoSeleccionadaId)
                    ...
                    <div class="sm:col-span-1">
                        <label for="first-name"
                            class="block text-sm font-medium leading-6 text-gray-900">Total</label>
                        <div class="mt-2">
                            <input type="text" wire:model='Total' autocomplete="given-name"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                @endif
