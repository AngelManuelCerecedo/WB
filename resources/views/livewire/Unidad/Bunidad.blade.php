<div class="container">
    <div class="py-8">
        <div class="flex mb-4">
            <h2 class="text-4xl font-[Raleway]-semibold leading-tight mr-80">Unidades de Medida</h2>
            <label class="ml-40 mt-6">Inicio <i class="bi bi-chevron-right"></i> Catálogos <i
                    class="bi bi-chevron-right"></i> Unidades de Medida</label>
        </div>
        <div class="panel">
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="mt-8 flex flex-row mb-1 sm:mb-0">
                    ...
                    <div class="relative ml-72">
                        <a href="{{ route('RUnidades') }}">
                            <button class="botonL">
                                <i class="bi bi-plus-circle-fill"></i>
                                <span class="ml-2 ">Nueva Unidad de Medida</span>
                            </button>
                        </a>
                    </div>
                                ...
                                @foreach ($unidades as $unidad )
                                    <tr class="datosT">
                                        <td class="px-5 py-2 border border-gray-200 bg-white">
                                            <div class="flex">
                                                <div class="flex-shrink-0 w-10 h-10">
                                                    <a href="{{route('EUnidad',[$unidad ->id])}}">
                                                        <button class="botonm ml-14 mt-1">
                                        ...
                                        <td class="px-5 py-3 border border-gray-200 bg-white ">
                                            <p class="text-black whitespace-no-wrap">{{ $unidad ->Clave }}</p>
                                        </td>
                                        <td class="px-5 py-3 border border-gray-200 bg-white ">
                                            <p class="text-black whitespace-no-wrap">{{ $unidad ->Nombre }}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
