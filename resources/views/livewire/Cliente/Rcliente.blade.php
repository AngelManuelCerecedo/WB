<div class="container">
    <div class="py-8">
        <div class="flex mb-4">
            <h2 class="text-4xl font-[Raleway]-semibold leading-tight mr-64">Clientes</h2>
                ...
                <div class="ml-16">
                    ...
                    <div class="md:flex items-center mt-6">                
                        ...
                        <div class="flex flex-col ml-8">
                            ...
                            <input type="text" wire:model='DomF' class="input" placeholder="Domicilio Fiscal" />
                        </div>
                    </div>
                    <div class="md:flex items-center mt-6">                
                        <div class="flex flex-col  md:mt-0 mt-4">
                            ...
                            <select wire:model='CC' class="inputS">
                                <option value="">Seleccione una Opción</option>
                                <option value="Hospital">601 - Ley General de Personas Morales</option>
                                <option value="Medico General">603 - Personas Morales con fines no lucrativos</option>
                                <option value="Persona">605 - Sueldos y Salarios e Ingresos Asimilados a Salarios</option>
                                <option value="Clinica">606 - Arrendamiento</option>
                                <option value="Veterinaria">608 - Demás Ingresos</option>
                                <option value="Laboratorio">609 - Consolidación</option>
                                <option value="Gobierno">610 - Residentes en el Extranjero sin Establecimiento Permanente en México</option>
                                <option value="Distribuidor">611 - Ingresos por Dividendos (socios y accionistas)</option>
                                <option value="Hospital">612 - Personas Fisicas con Actividades Empresariales y Profesionales</option>
                                <option value="Medico General">614 - Ingresos por Intereses</option>
                                <option value="Persona">616 - Sin Obligaciones Fiscales</option>                            
                                <option value="Veterinaria">620 - Sociedades Cooperativas de Producción  que optan por diferir sus Ingresos</option>
                                <option value="Laboratorio">621 - Incoorporación Fiscal</option>
                                <option value="Gobierno">622 - Actividades Agrícolas, Ganaderas, Silvícolas y Pesqueras</option>
                                <option value="Distribuidor">623 - Opcional para Grupos de Sociedades</option>
                                <option value="Veterinaria">624 - Coordinados</option>
                                <option value="Laboratorio">628  - Hidrocarburos</option>
                                <option value="Gobierno">607 - Régimen en Enajenación o Adquisición de Bienes</option>
                                <option value="Distribuidor">629 - De los Regímenes Fiscales Preferentes y de las Empresas Multinacionales</option>
                            </select>
                        </div>
                        <div class="flex flex-col ml-8">
                            ...
                            <select wire:model='CC' class="inputS">
                                <option value="">Seleccione una Opción</option>
                                <option value="Hospital">G03 - Gastos en general</option>
                                <option value="Medico General">G01 - Adquisición de mercancias</option>
                                <option value="Persona">P01 - Por difinir</option>
                                <option value="Clinica">D01 - Honorarios médicos, dentales y gastos hospitalarios</option>
                                <option value="Veterinaria">D02 - Gastos médicos por incapacidad o discapacidad</option>
                                <option value="Laboratorio">D03 - Gastos funerales</option>
                                <option value="Gobierno">D04 - Donativos</option>
                                <option value="Distribuidor">D07 - Primas por seguros de gastos médicos</option>
                                <option value="Hospital">I02 - Mobiliario y equipo de oficina por inversiones</option>
                                <option value="Medico General">I08 - Otra maquinaria y equipo</option>
                                <option value="Persona">S01 - Sin efectos fiscales</option>
                            </select>
                        </div>
                    </div>
                </div>
