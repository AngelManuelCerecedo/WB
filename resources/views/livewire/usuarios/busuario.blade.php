<div class="container">
    <div class="py-8">
        <div class="flex mb-4">
            <h2 class="text-4xl titulos mr-80">Usuarios</h2>
            <label class="ml-80 mt-6">Inicio <i class="bi bi-chevron-right"></i> Usuarios <i
                    class="bi bi-chevron-right"></i> Usuarios</label>
        </div>
        <div class="panel">
                                    ...
                                    @if ($aux)
                                        <tr class="datosT">
                                            ...
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">{{ $usuario->name }}</p>
                                            </td>
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">{{ $usuario->mail }}</p>
                                            </td>
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">ROL</p>
                                            </td>
                                            <td class="px-5 py-3 border border-gray-200 bg-white">
