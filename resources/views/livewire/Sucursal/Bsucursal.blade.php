<div class="container">
    <div class="py-8">
        <div class="flex mb-4">
            <h2 class="text-4xl mr-72 titulos">Sucursales</h2>
        ...
        <div class="panel">
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="mt-8 flex flex-row mb-1 sm:mb-0">
                    ...
                    <div class=" ml-72">
                        <a href="{{ route('RSucursales') }}">
                            <button class="botonL">
                                <i class="bi bi-plus-lg text-lg"></i>
                                <span class="ml-2 ">Nueva Sucursal</span>
                            </button>
                        </a>
                    </div>
                    <div class=" ml-4">
                                    ...
                                    @if ($aux)
                                        <tr class="datosT">
                                            <td class="px-5 py-2 border border-gray-200 bg-white">
                                                <div class="flex">
                                                    <div class="flex-shrink-0 w-10 h-10">
                                                        <a href="{{ route('ESucursal', [$sucursal->id]) }}">
                                            ...
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">{{ $sucursal->Clave }}</p>
                                            </td>
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">{{ $sucursal->Nombre }}</p>
                                            </td>
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">{{ $sucursal->Zona }}</p>
                                            </td>
                                        </tr>
                                        <var {{$aux = false}}/>
                                    @else
