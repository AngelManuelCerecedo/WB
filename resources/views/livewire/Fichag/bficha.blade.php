<form>
    <div>
        @if ($ModalRPT)
            @include('livewire.Fichag.ModalRPT')
        @endif
        <div class="w-full">
            <div class="bg-white border border-gray-200 rounded p-4">
                <div class=" flex sm:flex-row flex-col">
                    ...
                    <div class="sm:ml-8 mt-1">
                        <a href="{{ route('RFichasG') }}">
                            <button class="botoNUEVOSR" type="button">
                                <i class="bi bi-plus-lg text-lg"></i>
                                <span class="ml-2">Nueva Ficha</span>
                            </button>
                        </a>
                    </div>
                    <div class="sm:ml-4 mt-1">
                        <button class="botoNUEVOSR" type="button" wire:click="abrirModal()">
